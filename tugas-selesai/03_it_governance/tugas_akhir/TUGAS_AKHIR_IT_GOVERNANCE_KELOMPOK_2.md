...
Struktur governance yang dirancang mengadopsi model three-tier (strategic, tactical, operational) dengan penetapan roles & responsibilities menggunakan RACI matrix. Gambar 2 menunjukkan struktur organisasi governance dengan tiga level: strategic (Direktur), tactical (Manager TI dan Manager Keuangan), dan operational (Staff TI). Setiap level memiliki tanggung jawab yang spesifik dalam mendukung implementasi framework tata kelola TI.

![Struktur Governance SATRIAMART](plantuml/images/gambar_2a_struktur_governance.png)
Sumber: (Hasil Penelitian, 2025)
**Gambar 2. Struktur Governance SATRIAMART**

Untuk memastikan clarity dalam roles & responsibilities, penelitian ini mengembangkan RACI matrix yang mencakup 12 proses kunci dalam tata kelola TI. Tabel 6 menunjukkan RACI matrix yang mendefinisikan peran Responsible (Pelaksana), Accountable (Penanggung Jawab), Consulted (Konsultasi), dan Informed (Informasi) untuk setiap proses. RACI matrix ini menjadi panduan operasional dalam implementasi framework untuk menghindari konflik peran dan memastikan akuntabilitas yang jelas.

**Tabel 9. RACI Matrix - Key Processes SATRIAMART**

| Proses | Direktur | Manager TI | Staff TI | Finance |
|--------|----------|------------|----------|---------|
| Penetapan Kebijakan TI | **A** | R | C | I |
| Risk Assessment & Mitigation | **A** | R | C | I |
| Budget Approval TI | **A** | R | I | C |
| Implementasi Framework COBIT | I | **A/R** | R | I |
| Monitoring & Reporting KPI | I | **A** | R | C |
| Backup & Disaster Recovery | I | **A** | R | I |
| Security & Access Control | C | **A** | R | I |
| Incident Management | I | **A** | R | I |
| Change Management | **A** | R | R | C |
| Internal Audit IT Governance | **A** | C | I | C |
| Training & Skill Development | **A** | R | C | C |
| Vendor & Contract Management | **A** | R | C | C |

**Keterangan:** R = Responsible (Pelaksana), A = Accountable (Penanggung Jawab), C = Consulted (Konsultasi), I = Informed (Informasi)

Sumber: (Hasil Penelitian, 2025)

Selain RACI matrix, penelitian ini juga merancang escalation path untuk penanganan insiden TI yang terstruktur. Gambar 3 menunjukkan mekanisme eskalasi tiga level dengan response time yang jelas: Level 1 (Staff TI, <2 jam), Level 2 (Manager TI, <4 jam), dan Level 3 (Direktur, <24 jam). Escalation path ini memastikan bahwa setiap insiden ditangani pada level yang tepat sesuai dengan kompleksitas dan dampak bisnisnya.

![Escalation Path](plantuml/images/gambar_2b_escalation_path.png)
Sumber: (Hasil Penelitian, 2025)
**Gambar 3. Escalation Path IT Incidents SATRIAMART**

Tabel 10 menunjukkan control objectives dan key performance indicators untuk setiap domain.

**Tabel 10. Control Objectives dan KPI per Domain**
...
Roadmap implementasi dirancang dalam empat fase selama 18–24 bulan: Quick Wins (Bulan 1–3), Short-term (Bulan 4–9), Medium-term (Bulan 10–18), dan Long-term (Bulan 19–24). Setiap fase memiliki fokus, deliverables, dan resource requirements yang spesifik. Tabel 11 menunjukkan roadmap implementasi dengan timeline dan deliverables utama setiap fase.

**Tabel 11. Roadmap Implementasi Framework Tata Kelola TI SATRIAMART (18-24 Bulan)**

| Fase | Aktivitas | Durasi | Timeline | Target Maturity |
|------|-----------|--------|----------|-----------------|
| **FASE 1: QUICK WINS** | | **Bulan 1-3** | **Jan-Mar 2026** | **1.2 → 1.7** |
| | Risk Register (20 risiko) | 30 hari | Jan 2026 | |
| | Automated Backup | 45 hari | Jan-Feb 2026 | |
| | RACI Matrix & Roles | 30 hari | Jan 2026 | |
| | SOP 5 Proses Kritikal | 60 hari | Jan-Mar 2026 | |
| | Dashboard Monitoring | 45 hari | Jan-Feb 2026 | |
| **FASE 2: SHORT-TERM** | | **Bulan 4-9** | **Apr-Sep 2026** | **1.7 → 2.2** |
| | Kebijakan Manajemen Risiko | 60 hari | Apr-Mei 2026 | |
| | Risk Assessment Quarterly | 90 hari | Apr-Jun 2026 | |
| | Upgrade Server & Load Balancing | 75 hari | Apr-Jun 2026 | |
| | Training COBIT 2019 | 45 hari | Mei-Jun 2026 | |
| | Change Management Procedure | 60 hari | Jul-Agu 2026 | |
| **FASE 3: MEDIUM-TERM** | | **Bulan 10-18** | **Okt 2026-Jun 2027** | **2.2 → 2.6** |
| | IAM Implementation | 90 hari | Okt-Des 2026 | |
| | Disaster Recovery Plan | 120 hari | Okt 2026-Jan 2027 | |
| | KPI TI integrated BSC | 90 hari | Feb-Apr 2027 | |
| | ITSM Tools | 105 hari | Feb-Mei 2027 | |
| | Internal Audit #1 | 30 hari | Jun 2027 | |
| **FASE 4: LONG-TERM** | | **Bulan 19-24** | **Jul-Des 2027** | **2.6 → 3.0** |
| | Process Optimization | 60 hari | Jul-Agu 2027 | |
| | Predictive Analytics | 90 hari | Jul-Sep 2027 | |
| | ISO 27001 Certification | 90 hari | Sep-Nov 2027 | |
| | Knowledge Transfer | 60 hari | Okt-Nov 2027 | |
| | Final Maturity Assessment | 30 hari | Des 2027 | |
...
Tabel 12 menunjukkan proyeksi peningkatan maturity level untuk setiap fase implementasi.

**Tabel 12. Proyeksi Peningkatan Maturity Level per Fase**
